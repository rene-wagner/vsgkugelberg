...
Defines the end-to-end testing infrastructure and requirements for the NestJS API. This specification covers test configuration, database setup, test helpers, and E2E test requirements for all API controllers.
...
This specification creates the new `api-testing` capability and enhances testing coverage for:
- `authentication-api` - E2E tests verify login flows and JWT cookies
- `user-api` - E2E tests verify user CRUD operations
- `post-api` - E2E tests verify post CRUD and filtering
- `category-api` - E2E tests verify category CRUD
- `tag-api` - E2E tests verify tag CRUD
- `department-api` - E2E tests verify department CRUD
- `health-check` - E2E tests verify health endpoint
