...
## Purpose
Provides a basic health check endpoint for monitoring systems, load balancers, and container orchestration platforms to verify the API service availability and readiness.
