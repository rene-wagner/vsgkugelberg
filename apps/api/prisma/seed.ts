...
const departmentData: Prisma.DepartmentCreateInput[] = [
  {
    name: 'Badminton',
    slug: 'badminton',
    shortDescription: 'Dynamic badminton club offering training and competitions for all skill levels.',
  ...
  },
  {
    name: 'Gymnastics',
    slug: 'gymnastics',
    shortDescription: 'Comprehensive gymnastics program for children and adults focusing on flexibility and strength.',
  ...
  },
  {
    name: 'Table Tennis',
    slug: 'table-tennis',
    shortDescription: 'Fast-paced table tennis club with regular training sessions and league competitions.',
  ...
  },
  {
    name: 'Volleyball',
    slug: 'volleyball',
    shortDescription: 'Team-oriented volleyball department offering indoor and beach volleyball programs.',
...
async function main() {
  ...
  for (const d of departmentData) {
    ...
    console.log(`Created department with id: ${department.id} (${department.name})`)
  }
