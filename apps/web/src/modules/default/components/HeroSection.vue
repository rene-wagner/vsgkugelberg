...
<template>
  ...
  >
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-6 py-20 text-center">
      ...
      <h2
        class="animate-slide-up font-display text-[4rem] leading-[0.9] tracking-[0.15em] text-vsg-gold-400 delay-300 md:text-[6rem] lg:text-[8rem]"
      >
        KUGELBERG
      </h2>
