...
watch(
  ...
  (newMembership) => {
    if (newMembership) {
      ctaHeadline.value = newMembership.ctaHeadline;
      ctaDescription.value = newMembership.ctaDescription;
    }
  },
  { immediate: true },
);
...
<template>
  ...
  >
    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
      <h2 class="font-display text-xl tracking-wider text-vsg-blue-900 mb-6 uppercase">CTA Bereich</h2>
