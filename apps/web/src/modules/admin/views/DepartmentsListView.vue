...
const departments = ref([
  {
    ...
    name: 'Badminton',
    description:
      'Unsere Badminton-Abteilung bietet Training fur alle Altersgruppen.',
  },
  {
    id: 2,
    name: 'Gymnastik',
    description: 'Fitness und Gesundheit durch vielfaltiges Gymnastik-Angebot.',
  },
  {
    id: 3,
    name: 'Tischtennis',
    description: 'Tischtennis fur Anfanger und Fortgeschrittene.',
  },
  {
    id: 4,
    name: 'Volleyball',
    description: 'Volleyball-Training und Wettkampfe fur alle Spielstarken.',
  },
]);
</script>
    ...
    >
      ...
      >
        <div class="font-body font-extralight text-sm text-gray-500">
          Zeige
          <span class="text-vsg-blue-900 font-medium">1-4</span> von
          <span class="text-vsg-blue-900 font-medium">4</span> Eintragen
        </div>
